        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
          <div className="lg:col-span-3 space-y-6 animate-fade-in">
            <div className="space-y-2">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-heading font-bold tracking-tight gradient-text">
                Akshit Jayesh Dhake
              </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Button asChild className="animated-gradient-bg hover-lift">
                <a href="#projects">
                  View My Work <ArrowRight className="ml-2 h-4 w-4 animation-float-horizontal" />
                </a>
              </Button>
            ...
            <div className="flex space-x-4 pt-2">
              <a
                ...
                className="hover:text-primary transition-colors animated-border p-2"
                aria-label="Github"
              >
          ...
          <div className="lg:col-span-2 flex justify-center lg:justify-end animate-fade-in">
            <div className="relative animation-float">
              <div className="w-64 h-64 sm:w-72 sm:h-72 rounded-full overflow-hidden border-4 border-primary/20 shine-effect">
              ...
              <div className="absolute -bottom-4 -right-4 bg-background rounded-lg p-4 shadow-lg gradient-card animation-pulse">
